...
import { CreateDemandLetterRequest, DeleteDemandLetterRequest, GetDemandsRequest, SetResponseRequest } from "./types";
...
export const getDemandDetails = createAsyncThunk(
    "getDemandDetails/Demand",
    async (demandID: string, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            ...
            const res = await axios.patch(`/demand/get/${demandID}`, {}, config);
...
export const setResponseOnDemand = createAsyncThunk(
    "setResponseOnDemand/Demand",
    async (setResponseRequest: SetResponseRequest, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            ...
            const res = await axios.put(`/demand/response/${setResponseRequest.demandID}`, setResponseRequest, config);
